...
A survival sandbox game built with Godot Engine.
...
2. Jalankan perintah:
```bash
   git clone https://github.com/Maler2/Cubeminer.git
```
3. Masuk ke folder proyek dan ketik:
```bash
   cd Cubeminer
```
**Cara 2: Download ZIP**
...
Proyek ini bersifat **Open Source** dan menggunakan lisensi [MIT License](LICENSE). Kamu bebas untuk memelajari, memodifikasi, dan membagikan ulang kodingan ini.